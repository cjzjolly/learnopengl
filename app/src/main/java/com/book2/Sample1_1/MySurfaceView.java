...
class MySurfaceView extends GLSurfaceView
{
    ...
    private class SceneRenderer implements GLSurfaceView.Renderer
    {
        ...
        public void onSurfaceCreated(GL10 gl, EGLConfig config)
        {
            ...
            //加载要绘制的物体
            lovo1=LoadUtil.loadFromFile("book2/Sample1_1/ch_t.obj", MySurfaceView.this.getResources(),MySurfaceView.this);
            lovo2=LoadUtil.loadFromFile("book2/Sample1_1/rg.obj", MySurfaceView.this.getResources(),MySurfaceView.this);
            //加载纹理

...
@SuppressLint("NewApi") public class LoadedObjectVertexNormalTexture
{
    ...
    {
        //加载顶点着色器的脚本内容
        mVertexShader=ShaderUtil.loadFromAssetsFile("book2/Sample1_5/vertex.sh", mv.getResources());
        //加载片元着色器的脚本内容
        mFragmentShader=ShaderUtil.loadFromAssetsFile("book2/Sample1_5/frag.sh", mv.getResources());
        //基于顶点着色器与片元着色器创建程序

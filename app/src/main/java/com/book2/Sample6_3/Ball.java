...
import static com.book2.Sample6_3.Constant.UNIT_SIZE;
...
public class Ball {
	...
	public void initShader(MySurfaceView mv) {
		// 加载顶点着色器的脚本内容
		mVertexShader = ShaderUtil.loadFromAssetsFile("book2/Sample6_3/vertex.shader",
				mv.getResources());
		// 加载片元着色器的脚本内容
		mFragmentShader = ShaderUtil.loadFromAssetsFile("book2/Sample6_3/frag.shader",
				mv.getResources());
		// 基于顶点着色器与片元着色器创建程序

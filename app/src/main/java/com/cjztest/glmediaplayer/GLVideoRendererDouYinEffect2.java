...
public class GLVideoRendererDouYinEffect2 implements GLSurfaceView.Renderer
    ...
    public GLVideoRendererDouYinEffect2(Context context) {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        String fragmentShaderDouYin =
                "#extension GL_OES_EGL_image_external : require\n" +
                        ...
                        "void main() {\n" +
                        "\n" +
                        "        vec4 color = texture2D(sTexture, vec2(vTexCoord[0] * vColorOffset[0], vTexCoord[1]) * vColorOffset[0]);\n" +
                        "        gl_FragColor = color;\n" +
                        "\n" +
                        "}";
        //加载shader脚本 <<<

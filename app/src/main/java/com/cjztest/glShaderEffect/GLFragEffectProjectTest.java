...
public class GLFragEffectProjectTest extends GLLine {
    ...
    public GLFragEffectProjectTest(int baseProgramPointer, float x, float y, float z, float w, float h, int windowW, int windowH, Context context) {

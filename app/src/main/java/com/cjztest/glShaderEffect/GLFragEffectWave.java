...
public class GLFragEffectWave extends GLLine {
    ...
    public GLFragEffectWave(int baseProgramPointer, float x, float y, float z, float w, float h, int windowW, int windowH, Context context) {
